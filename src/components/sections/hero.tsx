    ...
    <section className="overflow-hidden border-b border-border/60 py-20 md:py-28">
      <Container className="max-w-5xl">
        <div className="grid items-center gap-12 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div
            className="relative mx-auto motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-6 motion-safe:duration-1000 motion-safe:delay-150"
            aria-hidden
          >
